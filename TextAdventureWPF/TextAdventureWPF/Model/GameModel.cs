    ...
    public class GameModel
    {
        ...
        public GameModel()
        {
            ...
            Screens = new List<Screen>
           {
               ...
               new Screen("Storage", "Cobwebs and dust is everywhere", null, new Screen[4], null, "/Images/Storage.png"),
               new Screen("Cave Deeper", "It's too dark here...", null, new Screen[4], null, "/Images/CaveEntrance.png"),
               new Screen("Storage2", "Hmmm", null, new Screen[4], null, "/Images/CaveEntrance.png"),
               new Screen("Unfinished", "There is a cold wind blowing", null, new Screen[4], null, "/Images/CaveEntrance.png")
           };
        ...
        public void UseItem()
        {
            ...
            foreach (var item in Player.PlayerInventory)
            {
                ...
                foreach (var entrance in Screens[currentScreen].Entrances)
                {
                    ...
                    {
                        Screens[currentScreen].EntrancesLockedId.Remove(key.DoorDirectionId);
                    }
                }
            }
        }
